...
public class BoardServiceImpl implements BoardService {
	...
	public Page<Board> getBoardList(String type, Search search, Pageable pageable) {
		...
		if (type.equals("notice")) {
			builder.and(qboard.cmCategory.eq(CmCategory.NOTICE));
		} else if (type.equals("lost")) {
			builder.and(qboard.cmCategory.eq(CmCategory.LOST));
		} else if (type.equals("food")) {
			builder.and(qboard.cmCategory.eq(CmCategory.FOOD));
		} else if (type.equals("tmi")) {
			builder.and(qboard.cmCategory.eq(CmCategory.TMI));
		} else if (type.equals("qna")) {
			builder.and(qboard.cmCategory.eq(CmCategory.QNA));
		} else if (type.equals("meet")) {
			builder.and(qboard.cmCategory.eq(CmCategory.MEET));
		}
